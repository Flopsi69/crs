...
if (!settings) {
  ...
  .lav-caption {
    ...
    font-weight: 700;
    line-height: 1;
    border-bottom: 1px solid #3856A7;
  }
  .box .wrapper .info h3 {
  ...
  .box .wrapper .accordion .total {
    font-size: 12px!important;
  }
  .box .wrapper .lines .content {
  ...
  .lav-caption__cancel-wrap div:hover {
    border-color: transparent;
  }
...
`;
  ...
  <div class='lav-modal-wrapper'>
    <style>
      ...
      .lav-confirm__caption {
        transition: 0.3s;
        cursor: pointer;
      }
      .lav-confirm__caption:hover {
        border-color: transparent;
      }
      .lav-modal__btn {
        background: #E95B44;
    ...
    <div class='lav-modal'>
      ...
      <div class='lav-confirm__inner lav-modal__inner'>
        <div class='lav-confirm__image'>
          <img src='${settings.dir}/img/confirm-desk.png'>
        </div>

        <div class='lav-confirm__info'>
      ...
      <div class='lav-cancel__inner lav-modal__inner'>
        <div class='lav-cancel__info'>
          <div class='lav-cancel__title lav-modal__title'>Cancel or reschedule <br> your subscription <span>anytime</span></div>
...
function init() {
  ...
  document.querySelector('.tm-text').insertAdjacentHTML(
    'beforebegin',
    `
  ...
  setInterval(() => {
    if (document.querySelector('.lav-caption__cancel-wrap')) {
      document
        .querySelector('.tm-text')
        .insertAdjacentElement(
          'beforebegin',
          document.querySelector('.lav-caption__cancel-wrap')
        );
    }
  }, 500);

  // document.querySelector('.tm-text').insertAdjacentElemeent(
  //   'beforebegin',
  //   `
  //   <div class='lav-caption__cancel-wrap'>
  //     <div class="lav-caption lav-caption__cancel">How to cancel your subscription?</div>

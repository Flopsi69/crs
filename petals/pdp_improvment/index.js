...
function closeSelector() {
  ...
  const label = _$('.lav-selector__inner.active .form__label')?.innerText.trim()
  if (label) {
...
function addLabel(container, target) {
  ...
  const text = _$('.jquery-grid-picker-item-selected', container)?.getAttribute(
    'data-jquery-grid-picker-value'
  )

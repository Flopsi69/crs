...
.lav-color--default .lav-color__image {
}
.lav-color__caption {
  margin-top: 8px;
  letter-spacing: 0;
}
.lav-selector-color .lav-color__image {
  // display: flex;
  // align-items: center;
  // justify-content: center;
  // border-radius: 50%;
...
`
  ...
  async function initExp() {
    ...
    // Tracking for free shipping in slide cart - commented as per request
    ...
    const markup = /*html*/ `
      <div class="lav-colors">
        <div class="lav-colors__title">
          Stone Color:
          <span>Original / No color</span>
        </div>
        <div class="lav-colors__list">
        ...
        <div class="lav-colors__caption">*Stone color cannot be changed for items created with Fabric or Flowers</div>
      </div>
    `
  ...
  function updateSizeAndLength() {
    ...
    function handleSize() {
      ...
      _$('select', newSelectorEl).addEventListener('change', function(e) {
        ...
        _$('span', newSelectorEl).innerText = val;

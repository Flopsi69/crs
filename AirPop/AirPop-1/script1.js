...
var pdpRowCustorm = `<div class="pd-row row" style="display: block;" data-gtm-vis-has-fired-31849418_134="1">
   <div class="pd-col col-xs-4 col-md-2" data-index-target="1" data-gtm-vis-has-fired-31849418_134="1">
   ...
   <div class="pd-col col-xs-4 col-md-2" data-index-target="2" data-gtm-vis-has-fired-31849418_134="1">
   ...
   <div class="pd-col col-xs-4 col-md-2" data-index-target="3" data-gtm-vis-has-fired-31849418_134="1">
...
<div class="pd-row row" style="display: block;" data-gtm-vis-has-fired-31849418_134="1">
...
switch (locationLang) {
  case 'it':
    productDescrTextValue = "La migliore mascherina quotidiana per tutti";
    break;
  case 'nl':
    productDescrTextValue = "Het beste mondmasker voor dagelijks gebruik voor iedereen";
    break;
  case 'de':
    productDescrTextValue = "Die beste alltagstaugliche gesichtsbedeckung für alle";
    break;
  
  default:
    productDescrTextValue = "The best everyday-use face covering for everyone";
    break;
}

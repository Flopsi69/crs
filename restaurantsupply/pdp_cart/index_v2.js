...
const stylesCart = /* css */ `
  ...
  .product-related-wrap .product-slider .product-slider-content:not(.active) {
    // display: none;
  }
  ...
  .checkout-cart-index .cart.table-wrapper tbody tr:not(:last-child) {
    border-bottom: 0;
  }
  .cart .item-info {
    border-top: 1px solid #EBECED;
  }
  .cart .item-info:nth-child(1) {
    border-top: none;
    margin-top: 0;
  }
  .lav-toggler {
    ...
    height: 36px;
    margin-left: auto;
    background-image: url('data:image/svg+xml;base64,');

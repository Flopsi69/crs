<?php
  ...
  $addonsList = makeHttpRequest('https://acuityscheduling.com/api/v1/appointment-addons');
  ...
  function addMetadataForAddons(&$addon) {
    ...
    if ($id == '1581536') {
      ...
      $addon['caption'] = 'todo description';
    } elseif ($id == '1785893') {
      $addon['caption'] = 'todo description';
    } elseif ($id == '1755839') {
...
<?php echo '<pre>'; print_r($addonsList); echo '</pre>'; ?>
...
<input type="hidden" id="step1-value" value="">
<input type="hidden" id="step2-value" value="">
<input type="hidden" id="logs-step__value5" value="">
<input type="hidden" id="logs-step__value6" value="">
    ...
    <div class="steps ff-lato">
      ...
      <div class="step packages" data-title="package">
        ...
        <div class="packages-list">
          ...
          ?>
          <!-- Item -->
          <div class="package" data-category="<?php echo $category ?>" data-id="<?php echo $id ?>" data-addons="<?php echo json_encode($addons) ?>">
            ...
            <div class="package-footer">
              <div class="package-price">
                ...
                <span class="package-price__caption">for <?php echo $adults; ?> adults</span>
              </div>

              <button class="package-btn link-btn dark booking-btn" data-value="<?php echo $name ?>" data-id="<?php echo $id ?>">Book</button>
            </div>
          </div> 
          <?php endforeach; ?>
        </div>
...
<script>
  class Booking {
    ...
    static backBtn = document.querySelector('.back');
    ...
    static initStep1() {
      for ( const btn of document.querySelectorAll('.service-btn')) {
        btn.addEventListener('click', (e) => {
          ...
          document.querySelector('#step1-value').value = serviceValue;
    ...
    static initStep2() {
      for ( const btn of document.querySelectorAll('.package-btn')) {
        btn.addEventListener('click', (e) => {
          ...
          for (const addonEl of document.querySelectorAll('.addon')) {
            console.log('addon', addonEl.dataset.id)
          ...
          document.querySelector('#step2-value').value = id;

          this.nextStep(packageValue)
        })
      }
    }
    ...
    static initStep3() {
      ...
      document.querySelector('.addons-btn').addEventListener('click', () => {
        ...
        for(const addonEl of document.querySelectorAll('.addon.active')) {
          caption += `${addonEl.querySelector('.addon-title').textContent}, `
        }
    ...
    static initStep5() {
      ...
      document.querySelector('.summary-btn').addEventListener('click', submitForm)
      ...
      function submitForm() {
        ...
        id=document.querySelector('#step2-value').value;
...
<script>
  ...
  async function initCalendar(container,container1,container2,container3,container4,container5,container6,container7) {
    ...
    function onSelectHandler({date, formattedDate}) {
      ...
      var xhttp = new XMLHttpRequest();
      xhttp.open("POST", "https://test.ukr-agro-select.com.ua/time.php", true);
      xhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
      xhttp.onreadystatechange = function() {
        if ( xhttp.readyState == 4 && xhttp.status == 200 ) {
          var response = JSON.parse(this.responseText);
          console.log('containersTimes', response)
      ...
      day1=date;
      appid=document.querySelector('#step2-value').value;
...
//  $( "body" ).on( "click", ".picker-times__item", function() {
// if ($(this).hasClass( "active" )){	 
// $(this).removeClass( "active" );
// $('.picker-times__btn').addClass( "picker-btn_disable" );
// }
// else {
// $(this).addClass( "active" );
// $('.picker-times__btn').removeClass( "picker-btn_disable" );	
// }
// }); 
//         }); 
</script>

...
<!-- echo '<pre>'; print_r($addonsList); echo '</pre>'; -->
          ...
          <div class="summary-info">
            <div class="summary-head">
              ...
              <div class="summary-brief">
                ...
                <div class="summary-brief__item">
                  ...
                  For up to 2 people, 90-Minute Session
                </div>
              </div>
            </div>
            ...
            <div class="summary-table">
              ...
              <div class="summary-row summary-row_name">
                <div class="summary-row__caption set-name">Date Night Package in private spa suite: </div>
                <div class="summary-row__value set-price">$249</div>
              </div>
              ...
              <div class="summary-addons">
                ...
                <div class="summary-row summary-row_addon">
                  <div class="summary-row__caption">Charcuterie Board:</div>
                  <div class="summary-row__value">$19</div>
                </div>

                <div class="summary-row summary-row_addon">
                  <div class="summary-row__caption">Happy Birthday Banner:</div>
              ...
              <div class="summary-row summary-row_final">
                ...
                <div class="summary-row__value set-total">$269</div>
              </div>
  ...
  class Booking {
    ...
    static initStep3() {
      ...
      document.querySelector('.addons-btn').addEventListener('click', () => {
        ...
        for(const addonEl of document.querySelectorAll('.addon.active')) {
          ...
          const addonData = { id, title, price };
    ...
    static initStep5() {
      ...
      document.querySelector('.summary-btn').addEventListener('click', async () => {
        ...
        console.log('orderData2', data);

        const caption = document.querySelector('#summary-firstname').value + ' ' + document.querySelector('#summary-lastname').value + ', ' + document.querySelector('#summary-email').value + ', ' + document.querySelector('#summary-phone').value + ', ' + document.querySelector('#summary-zip').value;
    ...
    static fillSummary() {
      ...
      document.querySelector('.set-total').textContent = '$0';
  ...
  async function initCalendar(container,container1,container2,container3,container4,container5,container6,container7) {
    ...
    function onSelectHandler({date, formattedDate}) {
      ...
      if (!date) { 
        ...
        // document.querySelector('.picker-times__choose').removeAttribute('style');
        // document.querySelector('.picker-note').removeAttribute('style');
        // document.querySelector('.picker-unavailable').removeAttribute('style');

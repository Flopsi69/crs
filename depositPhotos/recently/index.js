(function () {
  ...
  .lav-slider__close:hover {
    filter: invert(58%) sepia(38%) saturate(7498%) hue-rotate(170deg) brightness(91%) contrast(101%);
  }
  .lav-slider__link {
    display: block;
    padding: 0 5px;
  ...
  function initModalSlider() {
    ...
    window.modalSplide = new Splide('.lav-modal-slider', {
      // autoWidth: true,
      perPage: 8,
      pagination: false,
      // gap: '10px',
  ...
  function initRecentlySlider() {
    ...
    buildSlider(document.querySelector('.lav-slider .splide__list'));

    window.mainSplide = new Splide('.lav-slider', {
      autoWidth: true,
      // perPage: 10,
      pagination: false,
      // gap: '10px',
  ...
  function buildSlider(parent, isModal) {
    parent.innerHTML = '';
    recentlyStorage.forEach(function (item) {
      if (isModal) {
        parent.insertAdjacentHTML(
          'afterbegin',
          `
        <li class="splide__slide lav-modal-slider__slide">
          <a class='lav-modal-slider__link' href='${item[1]}'>
            <img class='lav-modal-slider__image' src='${item[0]}'>
          </a>
        </li>
        `
        );
        ...
        parent.insertAdjacentHTML(
          'afterbegin',
          `
        <li class="splide__slide lav-slider__slide">
          <a class='lav-slider__link' href='${item[1]}'>
            <img class='lav-slider__image' src='${item[0]}'>
          </a>
        </li>
        `
        );
  ...
  function setSessionItem(data) {
    ...
    window.mainSplide.add(
      '<li class= "splide__slide lav-slider__slide" > <a class="lav-slider__link" href="' +
        data[1] +
        '"><img class="lav-slider__image" src="' +
        data[0] +
        '"></a></li>',
      0
    );
              ...
              var o = (function (t, n, e, i) {
                ...
                function u(n, e) {
                  ...
                  n
                    ? (k(i, r), t.emit('' + o, a))
                    : P(i, r) &&
                      (S(i, r), t.emit(e ? 'hidden' : 'inactive', a));
                }
                function c() {
                  C(i, 'style', a.styles);
                }
          ...
          var e,
            ...
            o = {
              ...
              trim: function (t) {
                return (
                  i ||
                    (t = e.rewind ? this.rewind(t) : c(t, 0, this.edgeIndex)),
                  t
                );
              },
              rewind: function (t) {
                ...
                ? (function (t, n) {
                    ...
                    return {
                      ...
                      totalHeight: function (n) {
                        ...
                        var e = o.getSlide(n);
                        return e
                          ? M(e.slide).bottom - M(o.list).top + this.gap
                          : 0;
                      },
                      slideWidth: function () {

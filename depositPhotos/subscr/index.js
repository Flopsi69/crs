...
const advantagesCS = `
  <div class="mixed-plans-constructor__info-box _info-box">
    <ul class="plan-constructor__advantages" style='line-height: 1.5'>
        <li class="plan-constructor__advantage-item"><i class="plan-constructor__advantage-icon icon icon-ok icon-ok-blue"></i>Stahujte soubory kdykoli v průběhu roku</li>
        <li class="plan-constructor__advantage-item"><i class="plan-constructor__advantage-icon icon icon-ok icon-ok-blue"></i>Plný přístup do naší knihovny</li>
        <li class="plan-constructor__advantage-item"><i class="plan-constructor__advantage-icon icon icon-ok icon-ok-blue"></i>Stahujte fotografie a vektory (JPG, EPS a AI)</li>
        <li class="plan-constructor__advantage-item"><i class="plan-constructor__advantage-icon icon icon-ok icon-ok-blue"></i>Všechny velikosti souborů</li>
        <li class="plan-constructor__advantage-item"><i class="plan-constructor__advantage-icon icon icon-ok icon-ok-blue"></i>Tisk nebo digitální použití</li>
        <li class="plan-constructor__advantage-item"><i class="plan-constructor__advantage-icon icon icon-ok icon-ok-blue"></i>Použití pro marketing a reklamu</li>
        <li class="plan-constructor__advantage-item"><i class="plan-constructor__advantage-icon icon icon-ok icon-ok-blue"></i>Printing rights - <strong class='advantage-toggle-text'>up to</strong> 500,000 copies</li>
        <li class="plan-constructor__advantage-item"><i class="plan-constructor__advantage-icon icon icon-ok icon-ok-blue"></i>Celoživotní práva na používání snímků</li>

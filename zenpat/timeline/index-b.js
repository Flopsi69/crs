...
.lav-timeline__inner:before {
  ...
  left: 56px;
  width: 2px;
  background: url('${config.dir}/img/vertical-dash.svg') center center / 2px repeat-y;
}
...
.lav-timeline__image {
  ...
  line-height: 0;
  border-radius: 24px;
  background: lightgray -161.324px -134.78px / 412.868% 243.789% no-repeat;
...
function handleTimeline() {
  ...
  _$('.lav-timeline__btn').addEventListener('click', () => {
    ...
    pushDataLayer(
      'exp_zenpatch_journey_button_03',
      'Get it now',
      'click',
      'journey'
    )
...
const modalConfig = {
  ...
  modal2: {
    ...
    descr: `
      To ensure a consistent and effective release of essential oils, each ZenPatch undergoes a specialized infusion process. Our innovative <strong>AromaWeave™ technology</strong> locks in the highest quality essential oils, embedding them within a biodegradable bamboo fiber matrix. This advanced method allows for a <strong>controlled, steady diffusion</strong> of calming aromas, ensuring the long-lasting benefits of aromatherapy.<br/><br/>By embedding essential oils within a precisely engineered microstructure, ZenPatch <strong>delivers a microdose of natural aromas every 5 minutes,</strong> continuously stimulating olfactory receptors to promote relaxation and emotional balance. The result? A seamless, hassle-free aromatherapy experience that enhances tranquility throughout the day or night—without the need for reapplication or refills.<br/><br/>Experience the power of wearable aromatherapy, powered by science and designed for your well-being. 
    `,
...
function addModals() {
  ...
  _$('.lav-modal__btn').addEventListener('click', () => {
    _$('#ScienceBased #open').click()
    pushDataLayer(
      'exp_zenpatch_journey_button_02',
      'Get it now',
      'click',
      'Pop up journey'
    )
    ...
    static init() {
      ...
      document.addEventListener('click', (e) => {
        if (e.target.classList.contains('lav-modal')) {
          ...
          this.close()
          pushDataLayer(
            'exp_zenpatch_journey_button_01',
            'Close',
            'click',
            'Pop up journey'
          )

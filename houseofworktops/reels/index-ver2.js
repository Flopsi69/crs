(function(){
  ...
  const styles = /* css */ `
    .lav-reels {
      ...
      box-shadow: 0 4px 24px 0 rgba(215, 215, 215, 0.25);
    }
    .lav-reels__title {
      text-align: center;
      font-size: 20px;
  ...
  async function addReelsSection() {
    const markup = /* html */ `
      <div class="lav-reels">
        <div class="lav-reels__container">
    ...
    function renderSection() {
      ...
      const target = _$('section .position-sticky')
    ...
    async function initSplide() {
      ...
      const splide = new Splide('.splide', {
        ...
        perMove: 1,
        gap: '6px',
        padding: { left: '31px', right: '31px' }, // Show partial slides on sides
